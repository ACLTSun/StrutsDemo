...
public class QrImageService {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        // 插入图片
        QrImageService.insertImage(image, imgPath, needCompress);
        return image;
    }
    ...
    public static Boolean encode(String content, String imgPath, String destPath, boolean needCompress,String random) throws Exception {
        BufferedImage image = QrImageService.createImage(content, imgPath, needCompress);
        if(image==null){
            return false;
        }
        mkdirs(destPath);
    ...
    public static void encode(String content, OutputStream output) throws Exception {
    	QrImageService.encode(content, null, output, false);
    }
    ...
    public static String decode(String path) throws Exception {
        return QrImageService.decode(new File(path));
    }
    
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			QrImageService.encode("https://www.baidu.com/","","D:/",false,"baidu");
		} catch (Exception e) {
